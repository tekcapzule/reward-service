...
@Component
@Slf4j
public class ClaimRewardsFunction implements Function<Message<CreateContributionInput>, Message<Void>> {

    private final RewardService rewardService;

    private final AppConfig appConfig;

    public ClaimRewardsFunction(final RewardService rewardService, final AppConfig appConfig) {
